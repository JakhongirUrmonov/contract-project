...
const Hero = () => {
  return (
    <section className="max-w-8xl mx-auto bg-base-100 flex flex-col items-center justify-center gap-20 lg:gap-16 lg:px-20 px-8 py-8 lg:py-20 pb-0 lg:pb-0">
      <div className="flex flex-col gap-10 lg:gap-20 items-center justify-center text-center ">
        {/* <a
        ...
        <h1 className="max-w-4xl text-4xl lg:text-7xl tracking-tight md:-mb-4 pb-2">
          {/* Check Contracts Before Sign in a Few Seconds. */}
          Protect yourself from unfair contract terms.
        </h1>
        {/* <p className="max-w-4xl text-xl opacity-80 leading-relaxed">
          Upload work contract and get instant red flags.
        </p> */}
        <Dnd />
...
{/* 
        ...
        <div className="gap-6">
          <p className="flex items-center text-base text-secondary opacity-80 leading-relaxed justify-center">
          🇺🇸  Trusted by 12,000+ US emplyees and contractors that work with:
          </p>
          <div className="flex flex-wrap items-center justify-center lg:gap-20 gap-6 mt-8">
            <Image src="/img/Meta.svg" alt="Meta" height={32} width={101} className="transform scale-115"/>
            <Image src="/img/Google.svg" alt="Google" height={32} width={83} className="transform scale-115"/>
            <Image src="/img/Uber.svg" alt="Uber" height={32} width={111} className="transform scale-115"/>
            <Image src="/img/Walmart.svg" alt="Walmart" height={32} width={116} className="transform scale-115"/>
            <Image src="/img/Bull.svg" alt="Bull" height={32} width={135} className="transform scale-115"/>
            <Image src="/img/Apple.svg" alt="Apple" height={32} width={82} className="transform scale-115"/>
          </div>
        </div>
        <Image
          src="/img/hero.jpg"
